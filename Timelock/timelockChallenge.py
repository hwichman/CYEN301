...
import md5
import sys
allowHardcodedCurrentTime = False
allowHardcodedEpochTime = False
...
#add offset
if (subOffset):
        oCurrentTime = dtCurrentTime - timedelta(days=offsetDays,minutes=offsetMinutes,seconds=offsetseconds)
else:
        oCurrentTime = dtCurrentTime - timedelta(days=offsetDays,minutes=offsetMinutes,seconds=offsetseconds)
