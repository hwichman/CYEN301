...
workdir = ".lookee-here"   #allows to change the working directory, can be "main", "7" or "10" based on directory
...
#vigneredecode("spartans rock your world", "keaimaakJDCBROHJodrcwscs")
#main
